...
public final class LoginUserContext {
    ...
    public static void setCurrentUser(SysUser user, String loginIp, LocalDateTime loginTime) {
        StpUtil.getTokenSession().set(LOGIN_USER_KEY, LoginUserSession.from(user, loginIp, loginTime));
    }
